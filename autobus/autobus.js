...
function autobus(numberOfWheels){
    if (numberOfWheels % 4 === 0){
        return "Number of buses with 2 axles: " + numberOfWheels / 4
    }
    if(numberOfWheels % 6 === 0) {
        return "Number of buses with 3 axles: " + numberOfWheels / 6
    }
    ...
    if(remainder % 4 === 0){
        ...
        return "Number of buses with 3 axles: " + sumOfBus + ", Number of buses with 2 axles: " + sumTwoAxles
    } else if (remainder % 6 === 0){
        var sumThreeAxles = sumOfBus + numberWithThreeAxles
        return "Number of buses with 3 axles: " + sumOfBus + ", Number of buses with 2 axles: " + sumThreeAxles
    }
}
